  ...
  return (
    <div id="page-2" className={styles.container}>
      ...
      <p>
        ...
        exercitationem! Labore nostrum aliquid sit, cupiditate voluptatum sed
        quo laborum, voluptas, laboriosam mollitia quaerat iste temporibus nobis
        quasi quibusdam veniam!
      </p>
    </div>
  );
};
